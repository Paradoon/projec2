...
<h2>Testing</h2>
<h3>HTML TEST:</h3> Document checking completed. No errors or warnings to show.
<br><h3>CSS TEST:</h3> CSS level 3 + SVG
<br><h3>JAVASCRIPT TEST:</h3> No errors.

<h2>Future improvement</h2>
<li>Possibly add more levels and fruits/squares to increase time.</li>
<li>Better graphics</li>
<li>Moving obstacles that when crash, game over</li>
...
The live link can be found here - https://paradoon.github.io/projec2/
...
<h3>Content</h3>
The content is inspired by my life experiences and discoveries, by time, and by my nephew. I focused on how to touch the player and to give the feeling of stress and dedication rather than design, since in the end, it's a simple game. 
